use super::{emu::GameBoyEmulator, operations::*, utils::*, prefixed_instructions::PREFIX_n8};
...
impl Instruction {
    ...
    pub fn step(&mut self, emu: &mut GameBoyEmulator) -> bool {
        let step = std::mem::replace(&mut self.current_step, InstructionStep::Complete);
        if let InstructionStep::Running(step) = step {
...
impl From<u8> for Instruction {
    fn from(value: u8) -> Self {
        match value {
            ...
            0x22 => Instruction::new("LD (HL+), A".to_string(), |emu| {
            ...
            0x2A => Instruction::new("LD A, (HL+)".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
            ...
            0x32 => Instruction::new("LD (HL-), A".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let value = emu.cpu.get_register(Register::A);
                    emu.write_r16(RegisterPair::HL, value);
            ...
            0x34 => Instruction::new("INC (HL)".to_string(), |emu| {
            ...
            0x35 => Instruction::new("DEC (HL)".to_string(), |emu| {
            ...
            0x3A => Instruction::new("LD A, (HL-)".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let value = emu.read_r16(RegisterPair::HL);
                    emu.cpu.set_register(Register::A, value);
            ...
            0xC6 => Instruction::new(format!("ADD A, n8"), move |_emu| {
                    // ? One bus read or write per m-cycle.
            ...
            0xCD => CALL_n16(),
            0xCE => Instruction::new(format!("ADC A, n8"), move |_emu| {
                    // ? One bus read or write per m-cycle.
                    return InstructionStep::new(move |emu| {
            ...
            0xD6 => Instruction::new(format!("SUB A, n8"), move |_emu| {
                    // ? One bus read or write per m-cycle.
                    return InstructionStep::new(move |emu| {
                        let mut value = emu.read_pc();
            ...
            0xD7 => RST_n16(0x10),
            0xD8 => RET_c(Flag::C),
            0xD9 => Instruction::new("RETI".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let lsb = emu.read_sp();
                    return InstructionStep::new(|emu| {
            ...
            0xDE => Instruction::new(format!("SBC A, n8"), move |_emu| {
                    // ? One bus read or write per m-cycle.
                    return InstructionStep::new(move |emu| {
                        let mut value = emu.read_pc() + emu.cpu.get_flag(Flag::C) as u8;
                        value = emu.cpu.sub_register(Register::A, value);
            ...
            // * 0xE_
            0xE0 => Instruction::new("LD (0xFF00 + n8), A".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
            ...
            0xE2 => Instruction::new("LD (0xFF00 + C), A".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
            ...
            0xE6 => Instruction::new("AND A, n8".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let mut value = emu.read_pc();
            ...
            0xE7 => RST_n16(0x20),
            0xE8 => Instruction::new("ADD SP, i8".to_string(), |emu| {
                    // ? One bus read or write per m-cycle.
                    return InstructionStep::new(|emu| {
                        let value = emu.read_pc() as i8;
                        return InstructionStep::new(|emu| {
                            // ? Techincally writes upper and lower bytes seperately.
                            let value = emu.cpu.get_register_pair(RegisterPair::SP).wrapping_add_signed(value.into());
                            return InstructionStep::new(|emu| {
            ...
            0xEA => Instruction::new("LD (n16), A".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let lsb = emu.read_pc();
                    return InstructionStep::new(|emu| {
            ...
            0xEE => Instruction::new("XOR A, n8".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let mut value = emu.read_pc();
            ...
            // * 0xF_
            0xF0 => Instruction::new("LD A, (0xFF00 + n8)".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let address = 0xFF00 + emu.read_pc() as u16;
                    return InstructionStep::new(|emu| {
            ...
            0xF6 => Instruction::new("OR A, u8".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let mut value = emu.read_pc();
            ...
            0xF7 => RST_n16(0x30),
            0xF8 => Instruction::new("LD HL, SP + i8".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let value = emu.read_pc() as i8;
                    return InstructionStep::new(|emu| {
            ...
            0xFA => Instruction::new("LD A, (n16)".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
                    let lsb = emu.read_pc();
                    return InstructionStep::new(move |emu| {
            ...
            0xFE => Instruction::new("CP A, n8".to_string(), |emu| {
                // ? One bus read or write per m-cycle.
                return InstructionStep::new(|emu| {
